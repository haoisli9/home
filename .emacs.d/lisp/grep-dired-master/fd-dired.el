;;; fd-dired.el --- grep-dired alternative using fd  -*- lexical-binding: t; -*-
...
;; grep-dired, use fd instead.  Depend on grep-dired.
...
use in place of \"-ls\" as the final argument."
  ...
  (let ((dired-buffers dired-buffers))
    ...
    (set (make-local-variable 'dired-subdir-switches) grep-dired-find-ls-option)
    (setq buffer-read-only nil)
